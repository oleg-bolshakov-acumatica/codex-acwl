...
| `System.Threading.Tasks.TaskFactory.StartNew` all overloads           |   Method  |    General   | Use of the `TaskFactory.StartNew` method is forbidden in Acumatica because it may lead to deadlocks and a loss of Acumatica synchronization context. It also prevents Acumatica request profiler and resource governor from correctly managing system resources. |
...
| `System.Threading.Tasks.Task.Wait` all overloads                      |   Method  |    General   | Use of the `Task.Wait` method is forbidden in Acumatica because it may lead to deadlocks and a loss of Acumatica synchronization context. It also prevents Acumatica request profiler and resource governor from correctly managing system resources. |
| `System.Runtime.CompilerServices.TaskAwaiter.GetResult` all overloads |   Method  |    General   | Use of the `Task.GetAwaiter.GetResult()` pattern is forbidden in Acumatica because it may lead to deadlocks and a loss of Acumatica synchronization context. It also prevents Acumatica request profiler and resource governor from correctly managing system resources. |
| `System.Threading.Tasks.Task<T>.Result`                               | Property  |    General   | Use of the `Task<T>.Result` property is forbidden in Acumatica because it may lead to deadlocks and a loss of Acumatica synchronization context. It also prevents Acumatica request profiler and resource governor from correctly managing system resources. |
